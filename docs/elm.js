...
var $author$project$Main$ImageSelected = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Main$ImageUrl = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
...
var $author$project$Main$copyDown = F2(
	function (index, model) {
		switch (index) {
			case 0:
				var _new = A2(
					$author$project$Main$copyDown,
					$author$project$Main$saturatingInc(index),
					model);
				return _Utils_update(
					_new,
					{v: _new.J});
...
var $author$project$Main$shiftDown = F3(
	function (index, source, model) {
		return A3(
			$author$project$Main$replace,
			$author$project$Main$Cell(index),
			source,
			A2($author$project$Main$copyDown, index, model));
	});
			...
			case 0:
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						$author$project$Main$imageTypes,
						$author$project$Main$ImageSelected(action)));
			case 1:
				var action = msg.a;
				var file = msg.b;
				return _Utils_Tuple2(
					...
					A2(
						$elm$core$Task$perform,
						$author$project$Main$ImageUrl(action),
...
var $author$project$Main$absoluteContainerClass = $elm$html$Html$Attributes$class('absolute-container');
var $author$project$Main$absoluteClass = $elm$html$Html$Attributes$class('absolute');
var $author$project$Main$ImageRequested = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$ShiftDown = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$cellReplaceOnClick = function (index) {
	return $elm$html$Html$Events$onClick(
		$author$project$Main$ImageRequested(
			$author$project$Main$Replace(
				$author$project$Main$Cell(index))));
};
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Main$overlayClass = $elm$html$Html$Attributes$class('overlay');
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Main$cellOverlay = function (index) {
	var cellOverlayButtonSizeClass = $elm$html$Html$Attributes$class('cell-overlay-button-size');
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[$author$project$Main$absoluteClass, $author$project$Main$overlayClass]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Main$absoluteClass,
						$author$project$Main$cellReplaceOnClick(index)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('replace image')
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						...
						$author$project$Main$ImageRequested(
							$author$project$Main$ShiftDown(index))),
						$elm$html$Html$Attributes$class('cell-overlay-button1')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('shift down')
					]))
			]));
};
var $author$project$Main$cellSizeClass = $elm$html$Html$Attributes$class('insta-preview-cell-size');
var $author$project$Main$cellUploadButton = function (index) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$author$project$Main$cellSizeClass,
				$author$project$Main$absoluteClass,
				$author$project$Main$cellReplaceOnClick(index)
			]),
		_List_fromArray(
...
var $author$project$Main$overlayContainerClass = $elm$html$Html$Attributes$class('overlay-container');
...
var $author$project$Main$toInt = function (index) {
	switch (index) {
		case 0:
			return 0;
		case 1:
...
var $author$project$Main$cell = F2(
	function (index, imageState) {
		var cellIndexClass = $elm$html$Html$Attributes$class(
			'insta-preview-cell' + $elm$core$String$fromInt(
				$author$project$Main$toInt(index)));
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[$author$project$Main$absoluteClass, $author$project$Main$cellSizeClass, cellIndexClass, $author$project$Main$overlayContainerClass]),
			function () {
				if (imageState.$ === 1) {
					return _List_fromArray(
						[
							$author$project$Main$cellUploadButton(index)
						]);
				} else {
					var source = imageState.a;
					return _List_fromArray(
						[
							A2(
							$elm$html$Html$img,
							...
							_List_Nil),
							$author$project$Main$cellOverlay(index)
						]);
				}
			}());
	});
...
var $author$project$Main$profile = function (imageState) {
	...
	var replaceButton = A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$onClick(
				$author$project$Main$ImageRequested(
					$author$project$Main$Replace($author$project$Main$Profile)))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text('upload image')
	...
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[$author$project$Main$absoluteClass, profileSizeClass, $author$project$Main$overlayContainerClass]),
		function () {
			if (imageState.$ === 1) {
				return _List_fromArray(
					[replaceButton]);
